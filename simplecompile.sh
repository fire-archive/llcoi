...
g++ -g -O2 -fPIC -m64 -I$ogrehdrdir -I$ogrebstdir -I$oishdrdir -I./interface/include -L$ogrelibdir -L$oislibdir -lOgreMain -lOIS -shared -o libllcoi.so interface/source/*.cpp #-ansi -pedantic
